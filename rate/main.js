...
slider.on('change', (v) => {
  interval = [0.25,0.2,0.18,0.15,0.12,0.1,0.075,0.05,0.04,0.03][v]
  sustain = [0.2,0.15,0.09,0.08,0.07,0.07,0.05,0.04,0.03,0.019][v]
  release = [0.01,0.01,0.01,0.01,0.005,0.005,0.005,0.005,0.003,0.001][v]
  linediv = [5,7,10,15,20,25,30,40,50,60][v]
